...
public class RedisUtils {
     ...
     * @return
     */
    public boolean lrSetAll(String key, List<Object> value) {
        try {
     ...
     * @return
     */
    public boolean lrSetAll(String key, List<Object> value, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            if (time > 0) {
                expire(key, time);
    ...
    public boolean multiRemove(List<String> keyList) {
        try {
